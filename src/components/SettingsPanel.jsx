                ...
                {activeTab === 'general' && (
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {fields.map((field) => (
                                <div key={field.key} className={field.type === 'textarea' || field.type === 'date-range' || field.key === 'destinationAddress' ? 'col-span-full' : ''}>
                            ...
                            <div className="col-span-full pt-4 border-t sticky bottom-0 bg-white pb-2 flex justify-end">
                                {showSaveMessage ? (
                                    <div className="flex items-center text-green-600 gap-2 text-base font-bold bg-green-100 p-4 rounded-xl w-full justify-center">
                                        <Check size={24} />
                                    ...
                                    <button
                                        ...
                                        className="w-full md:w-auto flex items-center justify-center gap-2 bg-blue-600 text-white font-bold px-8 py-4 rounded-xl shadow-lg hover:bg-blue-700 active:scale-95 transition-all"
                                    >
                                        <Save size={20} />
                                        Save All Settings
                                    </button>
